...
Config::$clientKey = 'SB-Mid-client-S92WPmjAuJaARJin';
...
function printExampleWarningMessage() {
    if (strpos(Config::$clientKey, 'your ') != false ) {
        ...
        echo "<br>";
        echo "<br>";
        echo htmlspecialchars('Config::$clientKey = \'SB-Mid-client-S92WPmjAuJaARJin\';');
        die();
    } 
}
?>
...
<body>
    <script id="midtrans-script" type="text/javascript"
        src="https://api.midtrans.com/v2/assets/js/midtrans-new-3ds.min.js" data-environment="sandbox"
        data-client-key="<?php echo Config::$clientKey;?>"></script>
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/featherlight/1.7.12/featherlight.min.js">
    </script>

    <h1>Checkout</h1>
    <form action="{{ url('/proses') }}" method="POST" id="payment-form">
        @csrf
        <fieldset>
            ...
            <p>
                ...
                <input class="card-number" name="card-number" value="4811 1111 1111 1114" size="23" type="text"
                    autocomplete="off" />
            </p>
            <p>
                <label>Expiration (MM/YYYY)</label>
                <input class="card-expiry-month" name="card-expiry-month" value="12" placeholder="MM" size="2"
                    type="text" />
                <span> / </span>
                <input class="card-expiry-year" name="card-expiry-year" value="2025" placeholder="YYYY" size="4"
                    type="text" />
            </p>
            <p>
                <label>CVV</label>
