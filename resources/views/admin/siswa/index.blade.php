                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><span style="width: 20px;"><label class="checkbox checkbox-single"><input
                                                    ...
                                                    value="{{ $siswa->id_siswa }}">&nbsp;<span></span></label></span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="#"
                                            class="text-dark fw-bold text-hover-primary d-block mb-1 fs-6">{{$siswa->name}}</a>
                                    </td>
                                    <td>
                                        <a href="#"
                                    ...
                                    <td class="text-end">
                                        <a href="{{ url('siswas/'.$siswa->id.'/edit') }}"
